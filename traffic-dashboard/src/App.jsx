        ...
        <div className="relative z-10 p-4 md:p-6 max-w-[1600px] mx-auto">
          ...
          {currentView === 'dashboard' ? (
            <>
              ...
              <MapAndChartSection mapData={mapData} stats={stats} handleChartClick={handleChartClick} LONGDO_API_KEY={LONGDO_API_KEY} currentView={currentView} />
            ...
            <TrafficJamAnalytics rawData={rawData} />
          ) : currentView === 'accident' ? (
            <>
              <AccidentAnalytics rawData={rawData} />
              <MapAndChartSection mapData={mapData} stats={stats} handleChartClick={handleChartClick} LONGDO_API_KEY={LONGDO_API_KEY} currentView={currentView} />
            </>
          ) : currentView === 'div8_accident' ? (
            <Div8AccidentAnalytics rawData={rawData} />
          ) : null}
