...
export const DIVISION_COLORS = { "1": "#EF4444", "2": "#3B82F6", "3": "#10B981", "4": "#FBBF24", "5": "#A78BFA", "6": "#EC4899", "7": "#22D3EE", "8": "#6366F1" };
export const ORG_STRUCTURE = { "1": 6, "2": 6, "3": 5, "4": 5, "5": 6, "6": 6, "7": 5, "8": 4 };
export const EVENT_CATEGORIES = ['อุบัติเหตุใหญ่', 'อุบัติเหตุทั่วไป', 'จับกุม', 'ว.43', 'ช่องทางพิเศษ', 'จราจรติดขัด', 'ปิดช่องทางพิเศษ', 'จราจรปกติ'];
export const CATEGORY_COLORS = {
  'อุบัติเหตุใหญ่': '#EF4444',   // สีแดง
  'อุบัติเหตุทั่วไป': '#F97316', // สีส้ม
  'จับกุม': '#A855F7',         // สีม่วง
  'เมาแล้วขับ': '#D946EF',     // สีชมพูเข้ม (สำหรับเคสเฉพาะ)
